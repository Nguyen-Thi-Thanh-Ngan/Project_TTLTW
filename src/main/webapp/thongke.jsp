...
<%--&lt;%&ndash;                    <a><i class="fa fa-user-o"></i> <%= new UserServiceImpl().getRoleIdByUsername(SessionUtil.getInstance().getKey((HttpServletRequest) request, "user").toString()).getFullName() %></a>&ndash;%&gt;--%>
<%--                </c:if>--%>
